...
async function populateWolfgrammDeal() {
  ...
  try {
    for (const doc of documents) {
      ...
      // Use mutation API format
      const documentData = {
        fileName: doc.name, // Required by mutation
      ...
      const created = await convex.mutation(api.documents.create, documentData);
